...
final class InvalidWindow : Exception
{
    import gapi : CreateSurfaceInfo;

    public
    {
        CreateSurfaceInfo surfaceInfo;
    }

    this(CreateSurfaceInfo surfaceInfo, string file = __FILE__, size_t line = __LINE__, Throwable nextInChain = null) pure nothrow @nogc @safe
    {
        super("The window is damaged and invalid.", file, line, nextInChain);
